...
async function main() {
  ...
  // 3. EVENTS
  // ----------------------------------------------------------
  const [catMusic, catTech, catSports, catArts, catFood, catBusiness] =
    categories;
  ...
  const events = await Promise.all([
    ...
    prisma.event.upsert({
      ...
      create: {
        ...
        description:
          "Festival jazz terbesar di Asia Tenggara. Hadirkan musisi jazz kelas dunia selama 3 hari penuh di Jakarta.",
    ...
    prisma.event.upsert({
      ...
      create: {
        ...
        description:
          "Konferensi teknologi tahunan dengan topik AI, Web3, dan Cloud Computing. Gratis untuk semua peserta.",
    ...
    prisma.event.upsert({
      ...
      create: {
        ...
        description:
          "Fun run 5K dan 10K di kawasan Dago Bandung. Terbuka untuk semua kalangan, hadiah menarik menanti.",
    ...
    prisma.event.upsert({
      ...
      create: {
        ...
        description:
          "Pameran seni kontemporer menampilkan karya 50 seniman lokal dan internasional di Galeri Nasional.",
    ...
    prisma.event.upsert({
      ...
      create: {
        ...
        description:
          "Festival kuliner terbesar yang menyajikan ratusan hidangan khas dari 34 provinsi Indonesia.",
    ...
    prisma.event.upsert({
      ...
      create: {
        ...
        description:
          "Summit ekosistem startup Indonesia terbesar. Networking, pitching, dan workshop dari founder unicorn.",
    ...
    prisma.event.upsert({
      ...
      create: {
        ...
        description:
          "Malam apresiasi musik indie dengan 10 band lokal Bandung terbaik. Satu malam penuh kenangan.",
    ...
    data: [
      {
        ...
        rating: 5,
        comment:
          "Event luar biasa! Networking-nya sangat berkualitas dan speaker-nya inspiratif banget.",
      },
      {
        userId: customer2.id,
        eventId: summitEvent.id,
        rating: 4,
        comment:
          "Konten sangat bagus, tapi venue agak padat. Overall worth it banget!",
      },
      {
        userId: customer3.id,
        eventId: summitEvent.id,
        rating: 5,
        comment:
          "Salah satu event terbaik yang pernah saya hadiri. Pasti balik lagi tahun depan.",
      },
      {
        userId: customer1.id,
        eventId: indieEvent.id,
        rating: 5,
        comment:
          "Lineup band-nya top semua. Sound system keren dan atmosfernya malam itu luar biasa!",
      },
      {
        userId: customer4.id,
        eventId: indieEvent.id,
