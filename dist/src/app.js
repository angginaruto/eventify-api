...
app.post("/api/promotions/validate", (req, res) => {
    import("./modules/promotion/promotion.controller.js").then((m) => m.validatePromoCode(req, res));
});
app.get("/", (_req, res) => {
    res.sendSuccess({ version: "1.0.0", environment: process.env.NODE_ENV || "development" }, "Event Management API is running 🚀");
});
